...
export class LoginPage {
  ...
  Testlog(username, password) {
    ...
    //  let url = 'http://192.168.1.72/servicephp/getteacher.php?username=' + username + '&password=' + password;
     let url = 'http://192.168.1.4/servicephp/getteacher.php?username=' + username + '&password=' + password;
